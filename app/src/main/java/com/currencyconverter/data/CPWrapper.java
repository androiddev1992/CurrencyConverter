...
import com.currencyconverter.CurrencyConverterApplication;
import com.currencyconverter.data.provider.ConversionProvider;
...
public class CPWrapper {
    ...
    public static Cursor query(String tableName, String[] projection, String selection,
        ...
        Uri uri = Uri.parse(ConversionProvider.URL + "/" + tableName);

        return CurrencyConverterApplication.getInstance().getContentResolver().query(uri, projection, selection, selectionArgs, sortOrder);
    }

    public static Cursor queryDictionaryDB(Uri uri) {

        return CurrencyConverterApplication.getInstance().getContentResolver().query(uri, null, null, null, null);
    }
    ...
    public static void createTables(String sql) {
        ...
        CurrencyConverterApplication.getInstance().getContentResolver().call(ConversionProvider.CONTENT_URI, DB.METHOD_EXECUTE_SQL,
                sql, null);
    }
    ...
    public static List<String> getTableColumns(String tableName) {
        ...
        Bundle bundleResponse = CurrencyConverterApplication.getInstance().getContentResolver().call(Uri.parse(ConversionProvider.URL),
    ...
    public static String getCommaSeparatedColumns(String tableName) {
        ...
        Bundle response = CurrencyConverterApplication.getInstance().getContentResolver().call(Uri.parse(ConversionProvider.URL),
                DB.METHOD_GET_TABLE_COLUMNS, tableName, null);
    ...
    public static Boolean insert(String tableName, ContentValues values) {
        ...
        if (values != null) {
            ...
            return CurrencyConverterApplication.getInstance().getContentResolver().insert(
                    Uri.parse(ConversionProvider.URL + "/" + tableName), values) != null;
        }
    ...
    public static boolean delete(String tableName, String selection, String[] selectionArgs) {
        ...
        int count = CurrencyConverterApplication.getInstance().getContentResolver().delete(uri, selection, selectionArgs);
    ...
    public static boolean update(String tableName, ContentValues values, String selection,
        ...
        try {
            ...
            response = CurrencyConverterApplication.getInstance().getContentResolver()
    ...
    public static Bundle ExecuteRawQuery(String sql) throws Exception {
        ...
        return CurrencyConverterApplication.getInstance().getContentResolver().call(ConversionProvider.CONTENT_URI, DB.METHOD_RAW_SQL,
                sql, null);
    }
